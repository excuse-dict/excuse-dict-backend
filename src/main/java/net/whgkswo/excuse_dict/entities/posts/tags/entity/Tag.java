package net.whgkswo.excuse_dict.entities.posts.tags.entity;

import jakarta.persistence.*;
import lombok.Getter;
import lombok.Setter;
import net.whgkswo.excuse_dict.entities.BaseEntity;
import net.whgkswo.excuse_dict.lib.json.StringJsonToSetConverter;
...
public class Tag extends BaseEntity {
    ...
    public enum Category {
        ...
        RELIGIOUS(Set.of("종교", "신", "신앙", "수양", "믿음", "선행", "주님")),
        STUDY(Set.of("학교", "자격증", "취업", "공무원", "자기계발", "합격")),
        SUPERNATURAL(Set.of("심령", "귀신", "무서움", "공포", "유령", "초자연", "오컬트", "미스터리")),
