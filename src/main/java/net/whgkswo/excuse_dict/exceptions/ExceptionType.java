...
import net.whgkswo.excuse_dict.lib.time.TimeHelper;
...
public record ExceptionType(int status, String code, String message){
    ...
    public static final ExceptionType GUEST_TOKEN_INVALID = ExceptionType.of(401, "GUEST_TOKEN_INVALID", "비회원 토큰이 유효하지 않습니다.");
    public static final ExceptionType GUEST_TOKEN_REQUIRED = ExceptionType.of(401, "GUEST_TOKEN_REQUIRED", "비회원 토큰이 누락되었습니다.");
    ...
    public static final ExceptionType DELETED_COMMENT = ExceptionType.of(404, "DELETED_COMMENT", "삭제된 댓글입니다.");
    ...
    public static final ExceptionType DELETED_POST = ExceptionType.of(404, "DELETED_POST", "삭제된 게시글입니다.");
